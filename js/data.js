...
const workoutPlan = {
  days: [
    ...
    {
      day: 3,
      name: 'LEGS A — Quads + Femorales + Glúteos',
      focus: 'Fuerza e hipertrofia',
      warmup: '5 min bicicleta + activación de glúteos',
      exercises: [
        ...
        { name: 'Hip Thrust Machine', machine: 'hip-thrust', sets: 3, reps: '12-15', rest: 60, rir: 1, muscle: 'Glúteos' },
    ...
    {
      day: 6,
      name: 'LEGS B + GLUTES + CORE',
      focus: 'Hipertrofia + quema calórica',
      warmup: '5 min escaladora + activación de core',
      exercises: [
        ...
        { name: 'Patada de Glúteo en Máquina', machine: 'patada-gluteo', sets: 3, reps: '12-15', rest: 45, rir: 0, muscle: 'Glúteos' },
        { name: 'Pull Through en Polea', machine: 'pull-through', sets: 3, reps: '12-15', rest: 60, rir: 1, muscle: 'Glúteos + Femorales' },
